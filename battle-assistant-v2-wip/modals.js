...
if (openExtensionBtn) {
    openExtensionBtn.addEventListener("click", function(event) {
...
if (channelNameInput) {
    channelNameInput.addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
...
const goToChannelBtn = document.getElementById("goToChannelBtn");
if (goToChannelBtn) {
...
const goToDeemonriderBtn = document.getElementById("goToDeemonriderBtn");
if (goToDeemonriderBtn) {
    goToDeemonriderBtn.addEventListener("click", function() {
        navigateToChannel(); // Defaults to 'DeemonRider'
    });
}

const goToJonaswagernBtn = document.getElementById("goToJonaswagernBtn");
if (goToJonaswagernBtn) {
    goToJonaswagernBtn.addEventListener("click", function() {
